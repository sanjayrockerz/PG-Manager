...
export function OwnerLogin({ onSwitchToSignup, onLogin }: OwnerLoginProps) {
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 lg:p-12 bg-white">
        ...
        <div className="w-full max-w-[440px]">
          <div className="mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Sign in to RentCare</h2>
            <p className="text-gray-600 mt-2">Manage your PG properties</p>
          </div>
          ...
          <div className="text-center">
            ...
            >
              New to RentCare? Create a free account →
            </button>
          </div>
        </div>
      </div>
